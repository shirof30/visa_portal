...
// Shared eyebrow label style for section headers — plain text now that every
// section lives on the same opaque panel (no busy background behind it).
const sectionLabel = "text-[12px] font-bold uppercase tracking-[0.1em] text-[#8C909D]";
        ...
        <div className="relative mx-auto max-w-[1160px] px-4 sm:px-6 py-10 sm:py-14">
          ...
          <div className="relative bg-white/92 backdrop-blur-lg rounded-3xl border border-white/70 shadow-2xl shadow-black/10 overflow-hidden">
            <div className="p-6 sm:p-10">
              ...
              <section className="grid grid-cols-1 lg:grid-cols-2 gap-10 pb-10">
                ...
                >
                  <motion.div variants={fadeUp} className="relative">
                    <motion.span
                      aria-hidden
                      className="absolute -left-6 -top-8 h-24 w-24 rounded-full bg-emerald-400/20 blur-2xl"
                    ...
                    <h1 className="relative font-['Plus_Jakarta_Sans',sans-serif] text-[56px] sm:text-[64px] font-extrabold leading-none tracking-[-2px] text-[#111318] mb-1">
                      {heroTitle.slice(0, -1)}
                      <motion.span
                    ...
                    <p className="relative text-[16px] sm:text-[17px] font-medium text-[#8C909D] mt-3 leading-relaxed max-w-[380px]">
                      {t("hero.subtitle")}
                    </p>
                  </motion.div>
                  ...
                  <motion.div
                    variants={fadeUp}
                    className="bg-gray-50 border border-gray-100 rounded-xl px-6 py-5"
                  >
                    ...
                    <div className="flex flex-col gap-3">
                      {SERVICE_HOUR_SLOTS.map(({ dayKey, t1, t2 }, i) => (
                        <div key={dayKey}>
                          {i > 0 && <div className="h-px bg-gray-200 mb-3" />}
                    ...
                    <p className="text-xs text-[#8C909D] mt-4 pt-3 border-t border-gray-200 leading-relaxed">
                  ...
                  {VISA_CATEGORY_CODES.map((code) => {
                    ...
                    return (
                      <motion.button
                        ...
                        className="group relative text-left bg-gray-50 hover:bg-white rounded-xl border border-gray-100 hover:border-emerald-300 px-5 py-4 flex items-center justify-between gap-4 overflow-hidden hover:shadow-md hover:shadow-emerald-500/10 transition-all cursor-pointer"
                      >
              ...
              {/* How it works */}
              <motion.section
                className="relative border-t border-gray-100 pt-10 pb-10"
                variants={staggerContainer}
                initial="hidden"
                whileInView="show"
                viewport={{ once: true, amount: 0.3 }}
              >
                <motion.p variants={fadeUp} className={`${sectionLabel} mb-6`}>
                  {t("howToApply.title")}
                </motion.p>
                  ...
                  {HOW_TO_APPLY_STEPS.map(({ step, titleKey, descKey }, i) => {
                    ...
                    return (
                      <motion.div
                        ...
                        variants={fadeUp}
                        whileHover={{ y: -4 }}
                        className="relative bg-gray-50 rounded-xl border border-gray-100 px-5 py-5 transition-shadow duration-300 hover:shadow-md"
                      >
                        <motion.div
                          variants={scaleIn}
              ...
              >
                ...
                <motion.div
                  variants={fadeUp}
                  className="bg-gray-50 rounded-xl border border-gray-100 px-6 py-6"
                >
                  ...
                  <p className="mt-5 pt-5 border-t border-gray-200 text-xs text-[#8C909D] leading-relaxed">
