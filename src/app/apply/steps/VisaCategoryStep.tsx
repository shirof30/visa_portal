...
import { VISA_CATEGORIES, categoryNeedsSponsorLetter } from "../config/visaConfig";
...
export default function VisaCategoryStep({
  ...
  return (
    ...
    >
                ...
                <div className="min-w-0">
                  ...
                  {needsSponsor && (
                    <p className="text-[11px] text-amber-700 mt-1.5 flex items-center gap-1">
                      ...
                      Requires a sponsor/guarantor letter from Indonesia
                    </p>
                  )}
                </div>
              </div>
      ...
      <FieldError show={showError} message="Please select a visa category." />
