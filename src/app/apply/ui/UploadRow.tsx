...
export type UploadItem = {
  ...
  pdfOnly?: boolean;
  required?: boolean;
  sampleImage?: string; // path relative to /public, e.g. "/samples/passport.jpeg"
};
    ...
    >
      ...
      >
        <div className="flex items-center justify-between mb-3">
          <p className="text-sm font-semibold text-gray-700">Contoh: {label}</p>
          <button
            onClick={onClose}
        ...
        <p className="mt-2 text-center text-[11px] text-gray-400">
          Ini adalah contoh dokumen. Unggah dokumen asli Anda.
        </p>
      </div>
    </div>
  );
