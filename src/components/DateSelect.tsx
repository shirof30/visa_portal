...
export default function DateSelect({
    ...
    // appearance-none + pr-8: the native select arrow was crowding the text
    // in the narrow Day column once the font went to 16px — replaced with
    // our own chevron (rendered below) with guaranteed clearance.
